...
public enum AuthExceptionType implements ExceptionType {
    ...
    // 회원가입
    NICKNAME_DUPLICATED(Status.BAD_REQUEST, 4008, "NICKNAME DUPLICATED"),
    WRONG_PASSWORD(Status.BAD_REQUEST, 4009, "WRONG PASSWORD"),
    NICKNAME_TOO_LONG(Status.BAD_REQUEST, 4010, "NICKNAME TOO LONG"),
    ALREADY_SIGN_OUT(Status.UNAUTHORIZED, 4011, "ALREADY SIGN OUT")
    ;
